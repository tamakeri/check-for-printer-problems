...
def gonder(kime, içerik):
    driver.get(
        "https://mail.istesuit.com/m/printermail@yg.com.tr/PRIMARY/inbox/compose")
    time.sleep(10)
    driver.find_element(
